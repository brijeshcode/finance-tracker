...
const menuItems = ref([
    ...
    /* {
        title: 'Setups' , permission: 'setup access', role: '',
        subMenu:[
            { title:'Clients', route: 'admin.clients.index', permission: 'clients access' },
            { title:'Currencies', route: 'admin.currencies.index', permission: 'currencies access' },
            { title:'Cases', route: 'admin.cases.index', permission: 'Cases access' },
        ]
    }, */
    {
        title: 'Advance' , permission: 'advance setup access', role: 'admin',
        subMenu:[
            { title:'Users', route: 'admin.users.index', permission: 'users access' },
            { title:'Roles', route: 'admin.roles.index', permission: 'roles access' },
        ]
    },
    {
        title: 'Setup' , permission: 'advance setup access', role: 'admin',
        subMenu:[
            { title:'Stocks', route: 'admin.stocks.index', permission: 'users access' },
            { title:'Mutual Funds', route: 'admin.mutualFunds.index', permission: 'users access' }
        ]
    }
